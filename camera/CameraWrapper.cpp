...
void camera_fixup_capability(android::CameraParameters *params)
{
    ...
    if (params->get(
            android::CameraParameters::KEY_SONY_IMAGE_STABILISER_VALUES)) {
        const char *supportedIsModes = params->get(
                android::CameraParameters::KEY_SONY_IMAGE_STABILISER_VALUES);

        if (strstr(supportedIsModes,
                android::CameraParameters::VALUE_SONY_STILL_HDR) != NULL) {
            char buffer[512];
    ...
    const char *settings)
{
    ...
    if (params.get(android::CameraParameters::KEY_SONY_ISO_AVAIL_MODES)) {
        ...
        const char *isoModeList = params.get(
                android::CameraParameters::KEY_SONY_ISO_AVAIL_MODES);
        char buffer[255] = "ISO";
        size_t bufferPos = 3;
    ...
    if (params.get(android::CameraParameters::KEY_SONY_IMAGE_STABILISER)) {
        const char *sony_is = params.get(
                android::CameraParameters::KEY_SONY_IMAGE_STABILISER);
        if (strcmp(sony_is,
                android::CameraParameters::VALUE_SONY_STILL_HDR) == 0) {
            // Scene mode is HDR then (see fixup_setparams)
            params.set(android::CameraParameters::KEY_SCENE_MODE, "hdr");
        }
    }

    if (params.get(android::CameraParameters::KEY_SONY_VIDEO_HDR) &&
            params.get(android::CameraParameters::KEY_SONY_VIDEO_HDR_VALUES)) {
        params.set("video-hdr-values", params.get(
                android::CameraParameters::KEY_SONY_VIDEO_HDR_VALUES));
        params.set("video-hdr", params.get(
                android::CameraParameters::KEY_SONY_VIDEO_HDR));
    }
    ...
    if (params.get(android::CameraParameters::KEY_SONY_ISO_MODE)) {
        if (params.get(android::CameraParameters::KEY_SONY_AE_MODE_VALUES)) {
            const char *aeMode = params.get(
                    android::CameraParameters::KEY_SONY_AE_MODE);
            if (strcmp(aeMode, "auto") == 0 ) {
                ...
                char *isoVal = (char*)malloc(sizeof(char) * (3 + strlen(
                        params.get(
                            android::CameraParameters::KEY_SONY_ISO_MODE))));
        ...
        const char *settings)
{
    ...
    if (shutterSpeed) {
        if (strcmp(shutterSpeed, "auto") != 0) {
            ...
            params.set(android::CameraParameters::KEY_SONY_AE_MODE,
                    "shutter-prio");
        } else {
            const char *aeModes = params.get(
                    android::CameraParameters::KEY_SONY_AE_MODE_VALUES);
    ...
    if (params.get(android::CameraParameters::KEY_ISO_MODE)) {
        const char *isoMode = params.get(
                android::CameraParameters::KEY_ISO_MODE);
        if (strcmp(isoMode, "auto") != 0) {
            params.set(android::CameraParameters::KEY_SONY_ISO_MODE,
                    isoMode + 3);
        }
        if (params.get(android::CameraParameters::KEY_SONY_AE_MODE_VALUES)) {
            const char *aeModes = params.get(
    ...
    if (params.get(android::CameraParameters::KEY_SCENE_MODE)) {
        ...
        if (strcmp(sceneMode, "hdr") == 0) {
            params.set(android::CameraParameters::KEY_SONY_IMAGE_STABILISER,
                    android::CameraParameters::VALUE_SONY_STILL_HDR);
            params.set(android::CameraParameters::KEY_SCENE_MODE,
                    android::CameraParameters::SCENE_MODE_AUTO);
        } else {
            params.set(android::CameraParameters::KEY_SONY_IMAGE_STABILISER,
                    android::CameraParameters::VALUE_SONY_ON);
        }
    }

    if (params.get(android::CameraParameters::KEY_SONY_VIDEO_HDR) &&
            params.get("video-hdr")) {
        params.set(android::CameraParameters::KEY_SONY_VIDEO_HDR,
                params.get("video-hdr"));
    }

    if (params.get(android::CameraParameters::KEY_RECORDING_HINT) &&
            strcmp(params.get(android::CameraParameters::KEY_RECORDING_HINT),
            android::CameraParameters::TRUE) == 0) {
        if (params.get(
                android::CameraParameters::KEY_SONY_VIDEO_STABILISER_VALUES) &&
                (strstr(params.get(
                android::CameraParameters::KEY_SONY_VIDEO_STABILISER_VALUES),
                android::CameraParameters::VALUE_SONY_INTELLIGENT_ACTIVE)
                != NULL) ) {
            params.set(android::CameraParameters::KEY_SONY_VIDEO_STABILISER,
                    android::CameraParameters::VALUE_SONY_INTELLIGENT_ACTIVE);
        } else {
            params.set(
                    android::CameraParameters::KEY_SONY_VIDEO_STABILISER,
                    android::CameraParameters::VALUE_SONY_ON);
        }
        params.set(android::CameraParameters::KEY_SONY_IMAGE_STABILISER,
                android::CameraParameters::VALUE_SONY_OFF);
    }
