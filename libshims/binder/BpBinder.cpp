...
void BpBinder::onLastStrongRef(const void* __attribute__((unused)) id)
{
...
bool BpBinder::onIncStrongAttempted(uint32_t __attribute__((unused)) flags, const void* __attribute__((unused)) id)
{
