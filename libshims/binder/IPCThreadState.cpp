...
#define LOG_TAG "SHIM_IPCThreadState"
...
void IPCThreadState::stopProcess(bool __attribute__((unused)) immediate)
{
    ...
    int32_t handle, uint32_t code, const Parcel& data, status_t* statusBuffer)
{
    ...
    if (err == NO_ERROR) {
        ...
        tr.data.ptr.buffer = reinterpret_cast<uintptr_t>(data.ipcData());
        tr.offsets_size = data.ipcObjectsCount()*sizeof(size_t);
        tr.data.ptr.offsets = reinterpret_cast<uintptr_t>(data.ipcObjects());
...
void IPCThreadState::freeBuffer(Parcel* parcel, const uint8_t* data, size_t __attribute__((unused)) dataSize,
                                const size_t* __attribute__((unused)) objects, size_t __attribute__((unused)) objectsSize,
                                void* __attribute__((unused)) cookie)
{
